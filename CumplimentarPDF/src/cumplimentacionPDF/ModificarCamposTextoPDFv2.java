...
public class ModificarCamposTextoPDFv2 {
	...
	private static void tratarMenu(int opcion) throws CumplimentarPDFException {
		...
		Delegados_Modelo3 modelo3 = new Delegados_Modelo3("", "", "", "");
    	Delegados_Modelo5_1 modelo5_1 = new Delegados_Modelo5_1("", "", "", "", "", "");
    	Delegados_Modelo5_2_proceso modelo5_2P = new Delegados_Modelo5_2_proceso("", "", (short)1, (short)1, (short)1, (short)1);
    	Delegados_Modelo5_2_conclusion modelo5_2C = new Delegados_Modelo5_2_conclusion("", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", true, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "");
    	Delegados_Modelo9 modelo9 = new Delegados_Modelo9("", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "");
		...
		case 1:
			...
			solicitarDatosConstitucion(modelo3);
			solicitarFechaConstitucion(modelo3, modelo5_1);
			solicitarDatosEscrutinioBasico(modelo5_2P, modelo5_2C, modelo9);
...
//			break;
	...
	private static void solicitarDatosConstitucion(Delegados_Modelo3 modelo3) {
		...
		modelo3.setN_empresa(sc.nextLine().toUpperCase());
