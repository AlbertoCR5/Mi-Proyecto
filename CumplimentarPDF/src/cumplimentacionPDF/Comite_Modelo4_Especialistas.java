...
public class Comite_Modelo4_Especialistas extends Delegados_Modelo3 {

	private static final String ESPECIALISTAS = "ESPECIALISTAS Y NO CUALIFICADOS";
	short acta, t_mesa, varones, mujeres, numr;
	String colegio, n_mesa, lugar1;
	
	public Comite_Modelo4_Especialistas(short acta, String colegio, String n_empresa, String CIF, String direccion, String municipio)
			throws CumplimentarPDFException {
		super(n_empresa, CIF, direccion, municipio);
		this.acta = acta;
		this.colegio = ESPECIALISTAS;
	...
	public Comite_Modelo4_Especialistas(short acta, String colegio, short t_mesa, short varones, short mujeres, String n_empresa, String CIF, String n_comercial, String n_centro, String direccion,
		...
		setMeses(meses);
		setAno(ano);
		this.n_mesa = ESPECIALISTAS;
		this.numr = acta;
		this.lugar1 = ESPECIALISTAS;
