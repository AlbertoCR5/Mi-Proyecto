...
public class ModificarCamposTextoPDFv2 {
	...
	public static final String RUTA_ABSOLUTA = "C:\\Users\\alber\\Documents";
	public static final String RUTA_RELATIVA_DELEGADOS = "\\DAM\\Trabajo\\Documentacion Delegados";
	public static final String RUTA_RELATIVA_COMITE = "\\DAM\\Trabajo\\Documentacion Comite";
    ...
    public static final String AUTORIZACION = "\\autorizacion.pdf";
    public static final String CALENDARIO_DELEGADOS = "\\calendario_delegado.PDF";
    public static final String MODELO_3 = "\\modelo_3.pdf";
    public static final String MODELO_5_1 = "\\modelo_5_1.pdf";
    public static final String MODELO_5_2_PROCESO = "\\modelo_5_2_proceso.pdf";
    public static final String MODELO_5_2_CONCLUSION = "\\modelo_5_2_conclusion.pdf";
    public static final String MODELO_9 = "\\modelo_9.pdf";
    public static final String[] DOCUMENTACION_DELEGADOS = { CALENDARIO_DELEGADOS, MODELO_3, MODELO_5_1, MODELO_5_2_PROCESO, MODELO_5_2_CONCLUSION, MODELO_9, AUTORIZACION };
    ...
    public static final String AUTORIZACION_COMITE = "\\AUTORIZACION.pdf";
    public static final String CALENDARIO_COMITE = "\\calendario_comite.PDF";
    public static final String MODELO_3_COMITE = "\\Modelo_3.pdf";
	public static final String MODELO_4_ESPECIALISTAS = "\\modelo_4_Especialistas.pdf";
	public static final String MODELO_4_TECNICOS = "\\modelo_4_Tecnicos.pdf";
	public static final String MODELO_6_1_ESPECIALISTAS = "\\modelo_6_1_Especialistas.pdf";
	public static final String MODELO_6_1_TECNICOS = "\\modelo_6_1_Tecnicos.pdf";
	public static final String MODELO_6_2_ESPECIALISTAS = "\\modelo_6_2_Especialistas.pdf";
	public static final String MODELO_6_2_TECNICOS = "\\modelo_6_2_Tecnicos.pdf";
	public static final String MODELO_6_3_ESPECIALISTAS = "\\Comite\\modelo_6_3_Especialistas.pdf";
	public static final String MODELO_6_3_TECNICOS = "\\modelo_6_3_Tecnicos.pdf";
	public static final String MODELO_7_1 = "\\modelo_7_1.pdf";
	public static final String MODELO_7_2 = "\\modelo_7_2.pdf";
	public static final String MODELO_7_3_ACTA_GLOBAL = "\\modelo_7_3_acta_global.pdf";
	public static final String MODELO_7_3_ANEXO = "\\modelo_7_3_anexo.pdf";
	public static final String MODELO_7_3_PROCESO = "\\modelo_7_3_proceso.pdf";
	public static final String MODELO_9_COMITE = "\\modelo_9.pdf";
	...
	public static final String[] DOCUMENTACION_COMITE = { CALENDARIO_COMITE, MODELO_3_COMITE, MODELO_4_ESPECIALISTAS, MODELO_4_TECNICOS, MODELO_6_1_ESPECIALISTAS, MODELO_6_1_TECNICOS, MODELO_6_2_ESPECIALISTAS, 
														MODELO_6_2_TECNICOS, MODELO_6_3_ESPECIALISTAS, MODELO_6_3_TECNICOS, MODELO_7_1, MODELO_7_2, MODELO_7_3_ACTA_GLOBAL, MODELO_7_3_ANEXO, MODELO_7_3_PROCESO, MODELO_9_COMITE, AUTORIZACION_COMITE };
	...
	private static void tratarMenu(int opcion) throws CumplimentarPDFException {
		...
		StringBuilder [] sbDocumentacionDelegados = new StringBuilder[DOCUMENTACION_DELEGADOS.length];
		StringBuilder [] sbDocuementacionComite = new StringBuilder[DOCUMENTACION_COMITE.length];
		
		for (int i = 0; i < sbDocumentacionDelegados.length; i++) {
			sbDocumentacionDelegados[i].append(RUTA_ABSOLUTA + RUTA_RELATIVA_DELEGADOS + DOCUMENTACION_DELEGADOS[i]);
		}
		
		for (int i = 0; i < sbDocuementacionComite.length; i++) {
			sbDocuementacionComite[i].append(RUTA_ABSOLUTA + RUTA_RELATIVA_COMITE + DOCUMENTACION_COMITE[i]);
		}
		...
		case 1:
			...
			String[] rutaFormulario = new String[DOCUMENTACION_DELEGADOS.length];
			
			for (int i = 0; i < sbDocumentacionDelegados.length; i++) {
				rutaFormulario[i] = sbDocumentacionDelegados[i].toString();
			}
		...
		case 2:
			// Ruta de los formularios PDF
			String[] rutaFormulario2 = new String[DOCUMENTACION_DELEGADOS.length - 2];
			
			for (int i = 0; i < sbDocumentacionDelegados.length - 2; i++) {
				rutaFormulario2[i] = sbDocumentacionDelegados[i + 2].toString();
			}
		...
		case 3:
			...
			String[] rutaFormulario3 = { sbDocumentacionDelegados[0].toString(), sbDocumentacionDelegados[1].toString()};
			...
			// Ruta del formulario PDF
			for (String ruta : rutaFormulario3) {
				try {
					modificarCamposTextoPDF(ruta, modelo3, modelo5_1, modelo5_2P, modelo5_2C, modelo9);
				} catch (IOException e) {
					mostrarMensaje(e.getMessage());
                	...
                	if (rutaFormulario.equals(MODELO_5_1) && (modelo5_2C.isCasilla_de_verificacion2())) {
                		...
                		if (rutaFormulario.equals(MODELO_5_2_PROCESO) && (modelo5_2C.isCasilla_de_verificacion2())) {
                			...
                			if (rutaFormulario.equals(MODELO_5_2_CONCLUSION) && (modelo5_2C.isCasilla_de_verificacion2())) {
                            	...
                            	modificarCampoTexto(acroForm, "c.p", modelo5_2C.getC());
                            	button.setValue("Sí");
