	...
	private static void tratarMenu(int opcion) throws CumplimentarPDFException {
		...
		case 1:
			...
			for (String ruta : rutaFormulario) {
				try {
					modificarCamposTextoPDF(ruta, nombreEmpresa, CIF, municipio, direccion, fechaConstitucion, diaVotacion, mesVotacion, CP, totalElectores, varones);
				} catch (IOException e) {
					e.printStackTrace();
				}
			}
		...
		case 3:
			...
			// Ruta del formulario PDF
			try {
				modificarCamposTextoPDF(rutaFormulario3, nombreEmpresa, CIF, municipio, direccion, fechaConstitucion, diaVotacion, mesVotacion, CP, totalElectores, varones);
			} catch (IOException e) {
				e.printStackTrace();
			}
			break;
...
//	}
	...
	public static void modificarCamposTextoPDF(String rutaFormulario, String nombreEmpresa, String CIF, String municipio, String direccion, String fechaConstitucion, String diaVotacion, String mesVotacion, String CP, short totalElectores, short varones) throws IOException, CumplimentarPDFException {
        try (PDDocument pdfDocument = PDDocument.load(new File(rutaFormulario))) {
        	...
        	Delegados_Modelo5_2_conclusion modelo5_2C = new Delegados_Modelo5_2_conclusion(nombreEmpresa,nombreEmpresa, CIF, direccion, municipio, nombreEmpresa, direccion, direccion, municipio, CP, false, nombreEmpresa, nombreEmpresa);
                	...
                	if (rutaFormulario.equals(MODELO_5_1)) {
                		...
                		if (rutaFormulario.equals(MODELO_5_2_PROCESO)) {
                			...
                			if (rutaFormulario.equals(MODELO_5_2_CONCLUSION)) {
                            	...
                            	pdfDocument.save(MODELO_5_2_CONCLUSION_CUMPLIMENTADO.concat(nombreEmpresa).concat(EXTENSION));
            				}
                			else {
